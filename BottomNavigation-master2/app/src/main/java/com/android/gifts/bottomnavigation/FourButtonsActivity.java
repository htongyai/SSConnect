...
import com.android.gifts.bottomnavigation.fragments.news;
...
public class FourButtonsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomBar.setFragmentItems(getSupportFragmentManager(), R.id.fragmentContainer,
                new BottomBarFragment(new About(), R.drawable.homenav, "About"),
                new BottomBarFragment(new news(), R.drawable.nfisc, "News"),
                new BottomBarFragment(new events(), R.drawable.calsc, "Events"),
                new BottomBarFragment(new others(), R.drawable.ic_update_white_24dp, "Others")
                );
